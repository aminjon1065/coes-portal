-- Начальные подразделения и должности (docs/04-ДАННЫЕ.md § 5.5).
--
...
INSERT INTO org.org_unit (id, code, name, short_name, parent_id, path, kind, is_region_root)
SELECT gen_random_uuid(), д.code, д.name, д.short_name, ca.id, 'placeholder'::ltree, 'region', true
FROM (VALUES
