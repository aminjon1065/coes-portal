...
INSERT INTO ref.catalog (id, code, name, is_hierarchical, is_system, attribute_schema) VALUES
  ...
  (gen_random_uuid(), 'CASE_FILE',       'Номенклатура дел',              true,  true,  '["retentionRuleId"]'),
...
-- ─── CASE_FILE ───
('CASE_FILE','DEL-01','Приказы по основной деятельности',NULL,10,'{"retentionRuleId":"SRK-POST"}',NULL),
('CASE_FILE','DEL-02','Приказы по личному составу',NULL,20,'{"retentionRuleId":"SRK-75"}',NULL),
('CASE_FILE','DEL-03','Оперативные донесения о чрезвычайных ситуациях',NULL,30,'{"retentionRuleId":"SRK-05"}',NULL),
('CASE_FILE','DEL-04','Суточные сводки',NULL,40,'{"retentionRuleId":"SRK-03"}',NULL),
('CASE_FILE','DEL-05','Материалы по чрезвычайным ситуациям',NULL,50,'{"retentionRuleId":"SRK-10"}',NULL),
('CASE_FILE','DEL-06','Переписка с ведомствами',NULL,60,'{"retentionRuleId":"SRK-05"}',NULL),
('CASE_FILE','DEL-07','Планы и отчёты',NULL,70,'{"retentionRuleId":"SRK-POST"}',NULL),
('CASE_FILE','DEL-08','Акты об уничтожении документов',NULL,80,'{"retentionRuleId":"SRK-POST"}',NULL),
('CASE_FILE','DEL-09','Документы по личному составу',NULL,90,'{"retentionRuleId":"SRK-75"}',NULL),
-- ─── RETENTION_ACTION ───
