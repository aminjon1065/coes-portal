...
/**
 * Потолок точного подсчёта (§ 3.1). Больше него число строк не считается:
 * интерфейс показывает «более 10 000», а база не пересчитывает полмиллиона
 * строк ради заголовка списка.
 */
